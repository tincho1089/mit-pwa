...
import { TransmitterCalibrateThreePointComponent } from './transmitter-calibrate-three-point.component';
...
describe('TransmitterCalibrateThreePointComponent', () => {
  let component: TransmitterCalibrateThreePointComponent;
  let fixture: ComponentFixture<TransmitterCalibrateThreePointComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [TransmitterCalibrateThreePointComponent,MockTranslatePipe],
  ...
  beforeEach(inject([FormBuilder], async (fb: FormBuilder ) => {
    fixture = TestBed.createComponent(TransmitterCalibrateThreePointComponent);
    ...
    component.form = new FormGroup({ 
      'Main' : new FormGroup({
          'question1': await TransmitterCalibrateThreePointComponent.create(mockResponse,mockEquipments)
      })
  });
