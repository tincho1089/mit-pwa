export const ENV = {
 ...
 // enable version updater
  ...
  // external urls
  BaseAPI: "https://mobileinspections-api-dev-cvx.azurewebsites.net/api/",
  documents_api: "https://mobileinspections-api-dev-cvx.azurewebsites.net/api/inspection-workorder",
  webUrl: "https://mobileinspections-dev-cvx.azurewebsites.net",

  //environment definition
  shortName: "Dev",
  faviconHref: "assets/icons/icon-dev.png",
