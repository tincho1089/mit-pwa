export const ENV = {
  ...
  documents_api: "https://mobileinspections-api-qa-cvx.azurewebsites.net/api/inspection-workorder",
  webUrl: "https://mobileinspections-qa-cvx.azurewebsites.net",

  // environment definition
  shortName: "QA",
  faviconHref: "assets/icons/icon-stage.png",
