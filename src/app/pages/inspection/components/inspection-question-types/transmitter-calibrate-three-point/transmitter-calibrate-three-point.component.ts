...
@Component({
  selector: "transmitter-calibrate-three-point",
  templateUrl: "transmitter-calibrate-three-point.component.html",
  styleUrls: ["transmitter-calibrate-three-point.component.scss"]
})
export class TransmitterCalibrateThreePointComponent extends BaseInspection
  implements OnInit {
  @Input()
  ...
  columns = TransmitterCalibrateThreePointComponent.columns;
  static rows = [0, 1];
  rows = TransmitterCalibrateThreePointComponent.rows;
  static units: string = "";
  units = TransmitterCalibrateThreePointComponent.units;
  static outputUnits: string = "";
  outputUnits = TransmitterCalibrateThreePointComponent.outputUnits;
  static defaultUnits = "mA";
  defaultUnits = TransmitterCalibrateThreePointComponent.defaultUnits;
  static low: number = 0;
  low = TransmitterCalibrateThreePointComponent.low;
  static defaultSignalMin: number = 4;
  defaultSignalMin = TransmitterCalibrateThreePointComponent.defaultSignalMin;
  static high: number = 0;
  high = TransmitterCalibrateThreePointComponent.high;
  static defaultSignalMax = 20;
  defaultSignalMax = TransmitterCalibrateThreePointComponent.defaultSignalMax;

  static signalMin: number = 0;
  signalMin = TransmitterCalibrateThreePointComponent.signalMin;
  static signalMax: number = 0;
  signalMax = TransmitterCalibrateThreePointComponent.signalMax;

  static showSignal: boolean = false;
  showSignal = TransmitterCalibrateThreePointComponent.showSignal;
  static showThreePoint: boolean = false;
  showFivePoint = TransmitterCalibrateThreePointComponent.showThreePoint;
  static showEngUnit: boolean = false;
  showEngUnit = TransmitterCalibrateThreePointComponent.showEngUnit;
  static engUnit: string = "";
  engUnit = TransmitterCalibrateThreePointComponent.engUnit;
  static engMin: number = -1;
  engMin = TransmitterCalibrateThreePointComponent.engMin;
  static engMax: number = -1;
  engMax = TransmitterCalibrateThreePointComponent.engMax;
  static defaultVal: number = -99999;
  defaultVal = TransmitterCalibrateThreePointComponent.defaultVal;

  static tp1: number = -99999;
  tp1 = TransmitterCalibrateThreePointComponent.tp1;
  static tp2: number = -99999;
  tp2 = TransmitterCalibrateThreePointComponent.tp2;
  static tp3: number = -99999;
  tp3 = TransmitterCalibrateThreePointComponent.tp3;

  static accuracy: number = 0;
  accuracy = TransmitterCalibrateThreePointComponent.accuracy;
  ...
  static getTPs(equipDetails: Array<EquipDetails>) {
    try {
      ...
      const midSpan = (Number(maxSpan) - Number(minSpan)) / 2+"";
      this.tp2 = midSpan ? Number(midSpan) : this.defaultVal;
      this.tp3 = maxSpan ? Number(maxSpan) : this.defaultVal;
  ...
  static getUnits(equipDetails: Array<EquipDetails>) {
    ...
    try {
      ...
      if (this.showEngUnit) {
        TransmitterCalibrateThreePointComponent.columns = [
...
static updateTPsWithDefaultValues() {
  ...
  private onTestInputValueChanges(
    ...
    try {
      if (value) {
        target = TransmitterCalibrateThreePointComponent.getTargetOutput(value);
        ...
        engTarget = TransmitterCalibrateThreePointComponent.getEngOutput(value);
      }
    } catch { }
    group.patchValue(
      {
